...
resource "aws_vpc" "main" {
  ...
  tags = {
    Terraform = "true"
    Name      = "${random_pet.name.id}_quickstart_vpc"
  }
}
...
resource "aws_vpc_endpoint" "s3" {
  ...
  tags = {
    Terraform = "true"
    Name      = "${random_pet.name.id}_quickstart_vpc_endpoint"
  }
}
...
resource "aws_internet_gateway" "gw" {
  ...
  tags = {
    Name = "${random_pet.name.id}_quickstart_iGW"
  }
...
resource "aws_route_table" "private_A" {
 ...
 tags = {
    Name = "${random_pet.name.id}_quickstart_private_routes_A"
  }
}
...
resource "aws_route_table" "private_B" {
 ...
 tags = {
    Name = "${random_pet.name.id}_quickstart_private_routes_B"
  }
}
...
tags = {
    Name = "${random_pet.name.id}_quickstart_public_subnets"
  }
}
...
resource "aws_subnet" "private_A" {
 ...
 tags = {
    Name = "${random_pet.name.id}_quickstart_private_subnets_A"
  }
}
...
resource "aws_subnet" "private_B" {
 ...
 tags = {
    Name = "${random_pet.name.id}_quickstart_private_subnets_B"
  }
}
...
resource "aws_network_acl" "public" {
  ...
  tags = {
    Name = "${random_pet.name.id}_quickstart_shared_default_nework_acl"
  }
}
...
resource "aws_network_acl" "custom" {
  ...
  tags = {
    Name = "${random_pet.name.id}_quickstart_dedicated_custom_nework_acl"
  }
}
...
tags = {
    Name = "${random_pet.name.id}_quickstart_EIP_nat"
  }
}
...
tags = {
    Name = "${random_pet.name.id}_quickstart_EIP_nat_gateway"
  }
